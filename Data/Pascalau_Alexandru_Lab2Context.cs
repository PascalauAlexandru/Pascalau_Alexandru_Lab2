...
namespace Pascalau_Alexandru_Lab2.Data
{
    public class Pascalau_Alexandru_Lab2Context : DbContext
    {
        ...
        public DbSet<Pascalau_Alexandru_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Pascalau_Alexandru_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Pascalau_Alexandru_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
